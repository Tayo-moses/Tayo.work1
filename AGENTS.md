...
This document describes the architecture and conventions of the Tayo Adebayo portfolio site for AI agents and developers.

## Project Overview

A minimalist, editorial personal portfolio for Tayo Adebayo, a Nigerian product designer and founder based in Lagos. Single-page scroll experience hosted on Netlify, built with TanStack Start.
